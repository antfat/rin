...
# --- Константы ---
CUDA_VERSION="12.8"
CUDA_PKG="cuda-repo-ubuntu2404-${CUDA_VERSION}-local_12.8.0-570.86.10-1_amd64.deb"
CUDA_URL="https://developer.download.nvidia.com/compute/cuda/12.8.0/local_installers/$CUDA_PKG"
CUDA_PIN_URL="https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/x86_64/cuda-ubuntu2404.pin"
